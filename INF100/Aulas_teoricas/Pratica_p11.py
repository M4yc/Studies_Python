...
while num_jogadas < 9 and not alguem_venceu:
    ...
    for i in range(len(Tab)):
        for j in range(len(Tab)):
            if Tab[i, 0] == marca and Tab[i, 1] == marca and Tab[i, 2] == marca:
                alguem_venceu = True
                break
            if Tab[0, j] == marca and Tab[1, j] == marca and Tab[2, j] == marca:
                alguem_venceu = True
                break
            if Tab[0, 0] == marca and Tab[1, 1] == marca and Tab[2, 2] == marca:
                alguem_venceu = True
                break
            if Tab[0, 2] == marca and Tab[1, 1] == marca and Tab[2, 0] == marca:
                alguem_venceu = True
                break
            else:
                if jogador == 1:
